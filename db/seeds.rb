...
item1 = Item.create!(item_name:'Avocado', description: 'Freshly picked fruit', price: 150, rating: 5)
...
item2 = Item.create!(item_name:'Cabbage', description: 'Fresh and crispy vegetable', price: 50, rating: 3)
...
item4 = Item.create!(item_name:'Lemon', description: 'Tangy with a bit of sweetness fruit', price: 10, rating: 4)
item4.photo.attach(io: URI.open('https://valyou-dev.s3.us-west-1.amazonaws.com/farmersmarket/lemon.jpg'), filename:'lemon.jpg')
item5 = Item.create!(item_name:'Red Bell Pepper', description: 'Spicy and fresh fruit', price: 50, rating: 4)
...
item6 = Item.create!(item_name:'Backpack', description: 'Perfect bag for all locations', price:1800, rating: 5)
...
item7 = Item.create!(item_name:'Chocolate', description: 'Healthy snack made with high quality cocoa bean', price: 500, rating: 4)
...
item8 = Item.create!(item_name:'Throw', description: 'Comfortable blanket made with real wool', price: 3599, rating: 2)
item8.photo.attach(io: URI.open('https://valyou-dev.s3.us-west-1.amazonaws.com/minorityowned/throw1.jpg'), filename:'throw1.jpg')
item9 = Item.create!(item_name:'Memory Game', description: 'Intellectually fun game for adults and kids', price: 2099, rating: 5)
...
item12 = Item.create!(item_name:'Reusable bottles', description: 'Strong and durable glass bottles', price: 200, rating: 2)
...
item15 = Item.create!(item_name:'Key holder', description: 'Perfect board to stay organized with many keys', price: 5, rating: 5)
...
item16 = Item.create!(item_name:'Hair Mask', description: 'Keeps your hair healthy and luxuriously soft', price: 5599, rating: 5)
...
item17 = Item.create!(item_name:'Celery Juice Powder', description: 'Healthy vegetable beverage', price: 20, rating: 2)
...
item18 = Item.create!(item_name:'Fun Socks', description: 'Warm, cozy, cute socks for all', price: 1899, rating: 5)
...
item20 = Item.create!(item_name:'Scrub', description: 'Soft and versatile body scrub', price: 500, rating: 3)
item20.photo.attach(io: URI.open('https://valyou-dev.s3.us-west-1.amazonaws.com/womenowned/scrub.jpg'), filename:'scrub.jpg')
item21 = Item.create!(item_name:'Colorful Ropes', description: 'Fun and versatile ropes for all purposes', price: 2599, rating: 5)
item21.photo.attach(io: URI.open('https://valyou-dev.s3.us-west-1.amazonaws.com/veteranowned/ropes.jpg'), filename:'ropes.jpg')
item22 = Item.create!(item_name:'Trailmix Snacks', description: 'On-the-go food for hikes, trails, outdoor activities', price: 1299, rating: 4)
...
item23 = Item.create!(item_name:'Ear warmers', description: 'Cozy and comfortable wear for outdoor', price: 1999, rating: 5)
...
item24 = Item.create!(item_name:'Apron for cooking', description: 'Perfect dresscode to avoid food stains ', price: 1599, rating: 4)
item24.photo.attach(io: URI.open('https://valyou-dev.s3.us-west-1.amazonaws.com/veteranowned/apron.jpg'), filename:'apron.jpg')
item25 = Item.create!(item_name:'Camp Light', description: 'Very easy to use in various outdoor activities', price: 3999, rating: 5)
